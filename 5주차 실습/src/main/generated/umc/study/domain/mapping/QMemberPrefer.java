...
public class QMemberPrefer extends EntityPathBase<MemberPrefer> {
    ...
    public final umc.study.domain.common.QFoodCategory foodCategory;
    ...
    public QMemberPrefer(Class<? extends MemberPrefer> type, PathMetadata metadata, PathInits inits) {
        ...
        this.foodCategory = inits.isInitialized("foodCategory") ? new umc.study.domain.common.QFoodCategory(forProperty("foodCategory")) : null;
