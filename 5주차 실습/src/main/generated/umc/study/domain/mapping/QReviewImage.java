...
public class QReviewImage extends EntityPathBase<ReviewImage> {
    ...
    private static final long serialVersionUID = 133448577L;
    ...
    public final umc.study.domain.common.QReview review;
    ...
    public QReviewImage(Class<? extends ReviewImage> type, PathMetadata metadata, PathInits inits) {
        ...
        this.review = inits.isInitialized("review") ? new umc.study.domain.common.QReview(forProperty("review"), inits.get("review")) : null;
    }
